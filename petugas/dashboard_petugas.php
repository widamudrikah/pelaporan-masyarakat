...
$pengaduan_proses = get_pengaduan_by_status($_SESSION['name'], 'proses', $conn);

// Mendapatkan data pengaduan yang sudah selesai/tanggapan
$pengaduan_selesai = get_pengaduan_by_status($_SESSION['name'], 'selesai', $conn);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Selamat Datang, <?= $_SESSION['name'] ?></h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 bg-warning">
                                    <h6 class="m-0 font-weight-bold text-white">Grafik Pengaduan</h6>
                                </div>
                                <div class="card-body">
